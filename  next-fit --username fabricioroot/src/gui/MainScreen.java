...
public class MainScreen extends javax.swing.JApplet {
    ...
    int initialPosition = 0; //This variable stores the initial position that is used by the algorithm of the the manager package
    ...
    private void jButtonAlgorithmStepsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlgorithmStepsActionPerformed
        if(st != null) {
            ...
            this.initialPosition = st.getInitialPosition();
            this.initialPositionBlocks = st.getInitialPositionBlocks();
        }
        st = new AlgorithmStepsThread(this, this.jButtonAlgorithmSteps, this.finalMainMemory, this.memoryGenerator, this.processesQueue, this.jPanelAnimation, this.initialPosition, this.initialPositionBlocks);
        ...
        if(algorithmResult.get(0) != 0) {
            ...
            block.setToolTipText(String.valueOf(process.getSize()));
            ...
            if(this.initialPositionBlocks == 0) {
                if(steps <= 15) {
                    for(j = 0; j <= (steps - 1); j++){
                        ...
                        JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                    }
                }
                else {
                ...
                if((this.initialPositionBlocks <= 15) && (steps >= this.initialPositionBlocks)){
                    if(steps <= 15) {
                        for(j = (this.initialPositionBlocks - 1); j <= (steps - 1); j++){
                            block.setBounds(20+(j*35), orientationAxisY, 30, 30);
                            JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                        }
                    }
                        ...
                        if((steps > 15) && (steps <= 30)) {
                            // First row
                            for(j = (this.initialPositionBlocks - 1); j <= 14; j++){
                                block.setBounds(20+(j*35), orientationAxisY, 30, 30);
                                JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                            }
                            // Second row
                ...
                if((this.initialPositionBlocks > 15) && (this.initialPositionBlocks <= 30) && (steps >= this.initialPositionBlocks)){
                    if(steps <= 30) {
                        // Second row
                        for(j = (this.initialPositionBlocks - 16); j <= (steps - 16); j++){
                            block.setBounds(20+(j*35), (orientationAxisY + 60), 30, 30);
                            JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                        }
                    }
                        ...
                        if((steps > 30) && (steps <= 45)){
                            // Second row
                            for(j = (this.initialPositionBlocks - 16); j <= 14; j++){
                                block.setBounds(20+(j*35), (orientationAxisY + 60), 30, 30);
                                JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                            }
                            // third row
                ...
                if((this.initialPositionBlocks > 30) && (this.initialPositionBlocks <= 45) && (steps >= this.initialPositionBlocks)){
                    for(j = (this.initialPositionBlocks - 31); j <= (steps - 31); j++){
                        block.setBounds(20+(j*35), (orientationAxisY + 120), 30, 30);
                        JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                    }
                }
                    ...
                    if((this.initialPositionBlocks > 30) && (this.initialPositionBlocks <= 45) && (steps < this.initialPositionBlocks)){
                        if(steps <= 15) {
                            // Third Row
                            for(j = (this.initialPositionBlocks - 31); j <= 14; j++){
                                block.setBounds(20+(j*35), (orientationAxisY + 120), 30, 30);
                                JOptionPane.showInternalMessageDialog(jLabelNextStep, "", "Clique em 'OK' para o próximo passo", JOptionPane.PLAIN_MESSAGE);
                            }
                            // Going back ... First row
